        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4">
            {orders.map((order, i) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3 border-b border-slate-700/40 pb-2">
                  <div>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
                    ...
                    <span className="text-indigo-300 font-black text-base">${Number(order.total_price).toFixed(2)}</span>
                  </div>
                </div>
